...
//				}
//			
//				double average = sum/(timeFrame);
//				list.get(i).set("SMA" + "-" + timeFrame + "-" + str, average);
//			}
//		}
//			
//		return list;
...
//		int j = 1;
//		while(list.get(list.size() - j - timeFrame).get("SMA" + "-" + timeFrame + "-" + str) == null){
//			j++;
//		}
//		double yesterday = list.get(list.size() - j - timeFrame).get("SMA" + "-" + timeFrame + "-" + str);
//		
//		for(int i = list.size() - j - timeFrame; i >= 0; i--){
//			double value = (list.get(i).get(str) - yesterday) * multiplyer + yesterday;
//
//			list.get(i).set("EMA" + "-" + timeFrame + "-" + str, value);
//			yesterday = value;
//			
//		}
//		return list;
...
//			double newValue = list.get(i).get("EMA" + "-" + low + "-" +  "close") - list.get(i).get("EMA" + "-" + high + "-" +  "close");
//			if(newValue > max)
//				max = newValue;
//			if(newValue < min)
//				min = newValue;
//			list.get(i).set("MACD" + "-" + low + "-" + high, newValue);
//			list.get(i).set("MACD" + "-" + "RAW" + "-" + low + "-" + high, newValue);
//
//		} 
//		exponentialMovingAverage(list, 9,"MACD" + "-" + low + "-" + high);
//		for(int i = 0; i < list.size() - high - 9;i++){
//			list.get(i).set("MACD" + "-" +"HISTOGRAM"+ "-" + low + "-" + high,
//					        list.get(i).get("MACD" + "-" + low + "-" + high) - 
//					        list.get(i).get("EMA" + "-" + "9" + "-" + "MACD" + "-" + low + "-" + high));
//
//
//		} 
//		
//		generateUniformList(list, "MACD" + "-" + low + "-" + high);
//		generateUniformList(list, "EMA" + "-" + "9" + "-" + "MACD" + "-" + low + "-" + high,min,max);
//		for(int i = 0; i < list.size() - high - 9;i++){
//			list.get(i).set("MACD" + "-" +"HISTOGRAM"+ "-" + low + "-" + high,
//					        list.get(i).get("MACD" + "-" + low + "-" + high) - 
//					        list.get(i).get("EMA" + "-" + "9" + "-" + "MACD" + "-" + low + "-" + high));
...
//			list.get(i).set("BB-mid" + "-" + timeFrame,list.get(i).get("SMA" + "-" + timeFrame + "-" + "close") );
//			list.get(i).set("BB-high" + "-" + timeFrame, list.get(i).get("SMA" + "-" + timeFrame + "-" + "close") + 2*sd );
//			list.get(i).set("BB-low" + "-" + timeFrame,list.get(i).get("SMA" + "-" + timeFrame + "-" + "close") - 2*sd );	
//		}		
//		return list;
//	}
//	
...
//			list.get(i).set("ATR" + "-" + timeFrame, averageTrueValue);
...
//		
//		
//		generateUniformList(list,"ATR" + "-" + timeFrame);
//		
//		return list;
//	}
//	
...
//			
//			list.get(i).set("CE-long" + "-" + timeFrame,longCE);
//			list.get(i).set("CE-short" + "-" + timeFrame,shortCE);
//		}
//			
//		return list;
//		
...
//				
//			}
//			list.get(i).set("PC-high" + "-" + timeFrame, max);
//			list.get(i).set("PC-low" + "-" + timeFrame, min);
//			list.get(i).set("PC-mid" + "-" + timeFrame, ((max + min)/2));
//		}
//
//		return list;
//	}
...
//			previousADL = aDL;
//			list.get(i).set("ADL", aDL);
//			list.get(i).set("ADL" + "-" + "RAW", aDL);
//		}	
//		
//		generateUniformList(list, "ADL");
//		return list;
//	}
//	
...
//			list.get(i).set("AU"+ "-" + timeFrame, aU);
//			list.get(i).set("AD"+ "-" + timeFrame, aD);
//			list.get(i).set("ADIF"+ "-" + timeFrame, (aU - aD));
//		}	
//		
//		generateUniformList(list, "AU"+ "-" + timeFrame);
//		generateUniformList(list, "AD"+ "-" + timeFrame);
//		
//		for(int i = list.size() - 1 - (int) timeFrame; i >= 0; i--) {
//			
//			list.get(i).set("ADIF"+ "-" + timeFrame,(list.get(i).get("AU"+ "-" + timeFrame) - list.get(i).get("AD"+ "-" + timeFrame)));
//		}
//		
//		return list;
//	}
...
//			list.get(i).set("PVM"+"-"+timeFrame, nPVM);
//			list.get(i).set("PVM"+"-"+"RAW" + "-"+timeFrame, nPVM);
//			list.get(i).set("MVM"+"-"+timeFrame, nMVM);
//		}
//		
//		generateUniformList(list, "PVM"+"-"+timeFrame);
//		generateUniformList(list, "MVM"+"-"+timeFrame);
//		
//		return list;
//	}
//	
...
//			list.get(i).set("UO" + "-" + num1 + "-" + num2 + "-" + num3, uo);
//			list.get(i).set("UO" + "-" + "RAW" + "-" + num1 + "-" + num2 + "-" + num3, uo);
//
//			
//		}
//		
//		generateUniformList(list,"UO" + "-" + num1 + "-" + num2 + "-" + num3,0,100);
//
//		
//		return list;
//	}
...
//			list.get(i).set("SOK-full" + "-" + timeFrame  + "-" + sma, list.get(i).get("SMA" +"-" + sma + "-" + "SOK-fast" + "-" + timeFrame));
//		}
//		simpleMovingAverage(list, sma, "SOK-full" + "-" + timeFrame  + "-" + sma);
//
//		
//		generateUniformList(list,"SOK-fast" + "-" + timeFrame,0,100);
//		generateUniformList(list,"SMA" +"-" + sma + "-" + "SOK-fast" + "-" + timeFrame,0,100);
//		
//		generateUniformList(list,"SOK-full" + "-" + timeFrame + "-" + sma,0,100);
//		generateUniformList(list,"SMA" +"-" + sma + "-" + "SOK-full" + "-" + timeFrame + "-" + sma,0,100);
//		
//		return list;
//	}
//	
...
//			list.get(i).set("RSI" + "-" + timeFrame, rsi);	
//		}
//		
//		generateUniformList(list, "RSI" + "-" + timeFrame,0,100);	
//		return list;
//	}
//	
